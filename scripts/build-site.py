...
ART = {
 ...
 "rails2":("https://fernfant.github.io/neobank-stack/summary/rails-cheatsheet.html", "Payment rails one-pager", "Faster Payments, Bacs, CHAPS, ACH, SEPA, RTP and FedNow on one page: speed, direction, ceiling, and how long you stay exposed."),
}
...
{''.join(f'<a class="card" href="{u}"><span class="k">{k}</span><span class="h">{t}</span><span class="p">{d}</span></a>' for k,(u,t,d) in [("Architecture",ART["ref"]),("Independent bank",ART["indep"]),("Payment rails",ART["rails"]),("Monzo",ART["monzo"]),("Attribution",ART["vend"]),("Deep dive",ART["deep"]),("Summary",ART["brief"]),("Cheatsheet",ART["cheat"]),("Cards & BIN",ART["cards"]),("Rails one-pager",ART["rails2"])])}
</div>
